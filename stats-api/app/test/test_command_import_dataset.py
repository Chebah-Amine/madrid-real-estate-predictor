...
class TestImportCSV:
    ...
    EXPECTED_KEYS = [
        "_id", "title", "sq_mt_built", "sq_mt_useful", "n_rooms",
        "n_bathrooms", "raw_address", "street_name", "street_number",
        "floor", "is_floor_under", "neighborhood_id", "operation",
        "rent_price", "buy_price", "buy_price_by_area", "house_type_id",
        "is_renewal_needed", "is_new_development", "built_year",
        "has_central_heating", "has_individual_heating", "has_ac",
        "has_lift", "is_exterior", "has_garden", "has_pool",
        "has_terrace", "has_storage_room", "is_accessible",
        ...
        "full_address", "latitude", "longitude", "subtitle"
    ]
    ...
    def test_import_csv_duplicate_key(self, csv_importer, collection, test_csv_file):
        ...
        # Second insert should fail because _id duplicates (mongomock usually raises PyMongoError)
